...
Category: Review and Improvement of existing app
Tools: Figma

### Introduction

Breuninger Beyond is a UX redesign project for the loyalty area of the Breuninger app. The project was developed in the Advanced Usability Engineering course in collaboration with Breuninger designers.
...
The project was created in a team of four and focused on the Beyond member hub inside the Breuninger app. This area includes information such as points, member status, benefits, the Breuninger Card and vouchers.
...
Context: Beyond by Breuninger
Placeholder: Banner Ad)

### Challenge

The main challenge was improving the experience without losing the premium and minimal character of the Breuninger brand. The existing visual design already felt high-quality, but the information architecture was partly unclear.
...
The project was a group effort, but my main focus was the conceptual and visual development of the voucher area. I also contributed central ideas for the overall structure and visual direction of the redesign.
...
The process started with a heuristic analysis of the existing app screens. We identified problems such as unclear information hierarchy, inconsistent presentation of related elements and high cognitive load.
...
({Image: Beyond_Screen_Vouchers}
Context: Beyond App
Placeholder: Current Interface - Vouchers)

### Outcome

The final result was an interactive Figma prototype for a redesigned Beyond experience. The prototype included a clearer account structure, a more accessible voucher overview, improved voucher detail sheets and a more efficient card scanning flow.
...
This project taught me how important information architecture and consistency are in UX design. I learned how to work with an existing brand and design system while still improving usability and structure.
