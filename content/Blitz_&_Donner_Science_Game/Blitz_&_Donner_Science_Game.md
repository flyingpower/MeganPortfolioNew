...
The installation includes two interactive tasks.

In the first task, users estimate the distance of a thunderstorm. The system shows lightning first and thunder later, making the time difference visible and understandable. Users then use the potentiometer to enter the calculated distance.

In the second task, users choose a safe shelter during a thunderstorm. Options such as a tree, bush, car or house are shown, and the system explains which choice is safe and why. This connects the scientific explanation to a real-life situation.
