    ...
    <>
      ...
      <article className="mx-auto max-w-3xl px-6 py-16 md:px-10 md:py-24">
        ...
        <div className="mt-10 space-y-8 text-muted-foreground">
          <section>
            <h2 className="font-display text-2xl text-foreground">1. Data Protection at a Glance</h2>
            ...
            <h3 className="font-display mt-4 text-xl text-foreground">Data collection on this website</h3>
            <p className="mt-3">
            ...
            <p className="mt-3">
              <strong>How do I collect your data?</strong><br />
              On the one hand, your data is collected when you communicate it to me. This could, for example, be data you enter into an email. Other data is collected automatically or after your consent by IT systems when you visit the website. This is primarily technical data (e.g., internet browser, operating system, or time of the page request).
            </p>
            <p className="mt-3">
              <strong>What do I use your data for?</strong><br />
          ...
          <section>
            ...
            <p className="mt-3">
              This website is hosted externally. Personal data collected on this website is stored on the host's servers. This may primarily include IP addresses, contact requests, meta and communication data, contract data, contact details, names, website access, and other data generated via a website.
              The external hosting serves the purpose of fulfilling the contract with potential and existing customers (Art. 6(1)(b) GDPR) and the interest of a secure, fast, and efficient provision of my online offering by a professional provider (Art. 6(1)(f) GDPR).
            </p>
          </section>

          <section>
            <h2 className="font-display text-2xl text-foreground">3. General Notes and Mandatory Information</h2>
            ...
            <p className="mt-3">
              ...
              Werfmershalde 7<br />
              70190 Stuttgart<br />
              Email: <a href="mailto:megan@mymielke.de" className="underline hover:text-foreground transition-colors">megan@mymielke.de</a>
            </p>
            <p className="mt-3">
              The controller is the natural or legal person who alone or jointly with others determines the purposes and means of the processing of personal data (e.g., names, email addresses, etc.).
            </p>
            <h3 className="font-display mt-4 text-xl text-foreground">Revocation of your consent to data processing</h3>
            <p className="mt-3">
