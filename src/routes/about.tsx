        ...
        <div className="mt-16 grid gap-12 md:grid-cols-12">
          <div className="md:col-span-7 md:col-start-1">
            <p className="text-xl leading-relaxed text-foreground md:text-2xl">
              I'm Megan - a 20-year-old Information Design student at Hochschule der Medien
              Stuttgart. I work somewhere between UX, visual communication and digital experiences
              that feel structured, clear and still distinctly human.
            </p>
            <div className="mt-8 space-y-5 text-base leading-relaxed text-muted-foreground md:text-lg">
              <p>
                I care about design that works for people, not just for the screen. Good UX should
                guide without getting in the way. It should make the next step feel clear, reduce
                unnecessary effort, and let people focus on what they came to do.
              </p>
              <p>
                Outside of design, I care a lot about art, politics, history, languages, music and
                fashion. I think that's why I'm drawn to design that has both logic and atmosphere.
                In 2026, I joined <span className="text-foreground">Robert Bosch GmbH</span> for a
                UX design internship, working on enterprise prototypes, Figma workflows and
                AI-supported design processes.
              </p>
              <p>
                I'm currently open to UX, product design and information design opportunities. If we
                share a wavelength, I'd love to hear from you.
              </p>
            </div>
