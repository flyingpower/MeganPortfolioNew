...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description:
      "UX redesign of the loyalty area for the Breuninger mobile app to improve usability and clarity.",
    year: "2026",
    ...
    caseStudy: [
      ...
      },
      {
        ...
        image: {
          src: Beyond_Screen_Vouchers,
          caption: "Beyond App · Current Interface - Vouchers",
        },
      },
      {
        heading: "Outcome",
  ...
  },
  {
    ...
    description:
      "Evaluating the usability of Festo’s login system across connected platforms to improve Single Sign-On and trust.",
    year: "2026",
    ...
    caseStudy: [
      ...
      },
      {
        ...
        image: {
          src: Festo_Diagrams,
          caption: "Quantitative Findings · INTUI & AttrakDiff Diagrams",
        },
      },
      {
